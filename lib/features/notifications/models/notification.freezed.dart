...
mixin _$NotificationModel {
  ...
  int get hashCode => Object.hash(runtimeType, id, userId, title, body, isRead,
      type, const DeepCollectionEquality().hash(payload), createdAt);

  @override
  String toString() {
    return 'NotificationModel(id: $id, userId: $userId, title: $title, body: $body, isRead: $isRead, type: $type, payload: $payload, createdAt: $createdAt)';
  }
}
    ...
    switch (_that) {
      case _NotificationModel() when $default != null:
        return $default(_that.id, _that.userId, _that.title, _that.body,
            _that.isRead, _that.type, _that.payload, _that.createdAt);
      case _:
        return orElse();
    }
  }
...
class _NotificationModel implements NotificationModel {
  ...
  @override
  int get hashCode => Object.hash(runtimeType, id, userId, title, body, isRead,
      type, const DeepCollectionEquality().hash(_payload), createdAt);
